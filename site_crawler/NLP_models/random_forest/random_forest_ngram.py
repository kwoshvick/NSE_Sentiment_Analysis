...
def createRandomForest(X, y):
    svm_clf = Pipeline([('vect', CountVectorizer()), ('tfidf', TfidfTransformer()), ('RFC', RandomForestClassifier(kernel="linear", C=1))])
...
def svm_ngram(X, y):
    ...
    svm3 = Pipeline([('vect', CountVectorizer(ngram_range=(1, 2))), ('svm', RandomForestClassifier(kernel="linear", C=1))])
    ...
    svm4 = Pipeline([('vect', CountVectorizer(ngram_range=(1, 3))), ('svm', RandomForestClassifier(kernel="linear", C=1))])
